...
<body>
    ...
    <?php include 'myself.php';?>         <!-- 店铺介绍 -->
    <?php include 'rotate.php';?>         <!-- 轮播图 -->    
    <?php include 'search_wrap.php';?>         <!-- 搜索框 -->
    <?php include 'body_center.php';?>    <!-- 商品主体 -->
    <?php include 'body_down.php';?>      <!-- 下 主体 -->
    <?php include 'bodySuperDown.php';?>  <!-- 下 主体 2 -->
