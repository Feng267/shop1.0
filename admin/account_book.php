...
<body>
  ...
  <script>
    ...
    function append_ol(id,data) {
      ...
      $(id).append('<li><div class="little_icon little_icon3"></div><a href="' + '#' + '">已发货：<span>' + data[3] + '</span>笔</a></li>');
      $(id).append('<li><div class="little_icon little_icon4"></div><a href="' + '#' + '">已付款：<span>' + data[4] + '</span>笔</a></li>');
      $(id).append('<li><div class="little_icon little_icon5"></div><a href="' + '#' + '">未付款：<span>' + data[5] + '</span>笔</a></li>');
      $(id).append('<li><div class="little_icon little_icon6"></div><a href="' + '#' + '">单笔最高：<span>' + data[6] + '</span>元</a></li>');
      $(id).append('<li><div class="little_icon little_icon7"></div><a href="' + '#' + '">单笔最低：<span>' + data[7] + '</span>元</a></li>');
    }
